...
<body>
   ...
   <nav class="navbar">
      ...
      <a href="../Beverages/beverages.php">Beverages</a>
...
<div class="container">
   ...
   <div class="product-form-container">
      ...
      <form action="addItemCake.php" method="post" enctype="multipart/form-data">
   ...
   <div class="product-display">
      <table class="product-display-table">
         ...
         <tr>
            ...
            <td><img src="uploaded_imgC/<?php echo $row['C_Image']; ?>" height="100" alt=""></td>
            <td>$<?php echo $row['C_Price']; ?>/-</td>
            <td>
               <a href="updateCakes.php?edit=<?php echo $row['C_Id']; ?>" class="btn"> <i class="fas fa-edit"></i> edit </a>
               <a href="deleteCakes.php?delete=<?php echo $row['C_Id']; ?>" class="btn"> <i class="fas fa-trash"></i> delete </a>
            </td>
         </tr>
      <?php } ?>
      </table>
